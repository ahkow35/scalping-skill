...
description: >
  ...
  Long AND short setups, each with its own protocol module. Two modes — ENTRY
  (fresh thesis) and MANAGE (review open position). Trigger phrases: "/scalp",
  "/scalp <COIN>", "/scalp deep <COIN>", "/scalp short <COIN>",
  "/scalp deep short <COIN>", "/scalp manage [short] <COIN> <entry>",
  "scalp read", "scalp thesis", "scalp the tape", "review my <COIN> long",
  "review my <COIN> short", "manage my position", "what's the move now"
...
include `short`, the position/thesis is short.
